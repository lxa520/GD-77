...
//
#define USB_SEND_DATA_ADDRESS           0x00024216
#define USB_READ_DATA_ADDRESS           0x00039742
#define USB_RESET_BUFFER_ADDRESS        0x0002421c
#define USB_HOOK_BACK_ADDRESS           0x000398a2
#define USB_HOOK_CONTINUE_ADDRESS       0x00039a84
#define MEM_BUFFER                      0x1fff5f6c
